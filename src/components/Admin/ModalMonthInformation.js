  ...
  const generatePDF = () => {
    ...
    doc.html(document.querySelector("#contentpdf"), {
      callback: function (pdf) {
        doc.addImage(imaData, 'JPEG', 460, 20, 60, 40);
  ...
  return (
    <div className="bg-neutral-700 bg-opacity-60 fixed inset-0 z-50 justify-center items-center">
      <div className="justify-center items-center h-screen w-full left-0 top-0  ">
        <div className=" justify-center modal-space-container flex items-center min-h-screen" id="modal-month">
          <div className="card-content-month overflow-y-scroll
          justify-center items-center w-6/12 border-none shadow-lg  
          flex flex-col pointer-events-auto bg-white bg-clip-padding rounded-md 
          outline-none text-current md:w-10/12 sm:w-9/12 lg:w-9/12 xl:w-7/12">

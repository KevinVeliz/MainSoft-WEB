...
export const RegisterEmployeeManager = () => {
  ...
  const [messageErrorJob, setMessageErrorJob] = useState(null);
  ...
  const validationName = () => {
    if (expresionesR.nombre.test(name) && name !== "" && name.length > 0) {
      setIsValidName(true);
    } else {
  ...
  const validationLastName = () => {
    if (
      expresionesR.nombre.test(lastname) &&
      lastname !== "" &&
      lastname.length > 0
    ) {
  ...
  const validationEmail = () => {
    if (expresionesR.correo.test(emailEmp)) {
  ...
  const validationPassword = () => {
    if (expresionesR.password.test(password) && password.length > 5) {
            ...
            <div className="mt-8">
              <div>
                ...
                <p className="text-red-500">
                  {(mensaje = isValidName === false ? messageErrorName : "")}
                </p>
              </div>
              <div>
                ...
                <p className="text-red-500">
                  {
                    (mensaje =
                      isValidLastName === false ? messageErrorLastName : "")
                  }
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-red-500">
                  {
                    (mensaje =
                      isValidCedula === false ? messageErrorCedula : "")
                  }
                </p>
              </div>

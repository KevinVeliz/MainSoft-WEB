      ...
      {rol === "admin" ? (
        <div className="w-full min-h-screen bg-gray-200 flex flex-row">
          ...
          <div className="flex justify-center items-center">
            <div className=" text-card flex items-center justify-center w-9/12 rounded-xl mt-20">
          ...
          <section className="w-2/6 bg-white pb-2 pt-2">
            <div
              className="card-admin bg-gray-700/50 h-full rounded-3xl xl:w-9/12 ml-20 
        sm:w-80 sm:h-screen "
            >
              ...
              <div className="flex justify-center">
                <h1 className="text-3xl font-bold pt-5 text-white">MAINSOFT</h1>
              </div>
          ...
          hover:bg-white hover:text-black xl:w-60 py-2
          sm:w-52"
                >
                  REGISTRAR EMPLEADOS
                </button>
                <button
                  onClick={handleHours}
                  className="button-admin text-white border-solid rounded-lg 
          hover:bg-white hover:text-black xl:w-60 mt-5 py-2 sm:w-52"
                >
                  REPORTE HORAS
                </button>
          ...
          hover:bg-gray-500/50 hover:border-gray-500/50 hover:text-white xl:w-60  mt-5 bg-white rounded-lg
          sm:w-52"
                >
                  SALIR
                </button>
